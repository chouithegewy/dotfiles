...
- GNU Stow-managed dotfiles for `tmux`, `i3`, `i3status`, X startup/resources, zsh, Codex CLI config/rules, helper scripts, Oh My Zsh custom shell init, Git, Ghostty, GitHub CLI, btop, Chrome flags, desktop portal preferences, default app handlers, and a Rust `mold` config.
